...
- [NewStorageExtended](MockFacet.sol/struct.NewStorageExtended.md)
- [MockFacetInitializer](MockFacet.sol/contract.MockFacetInitializer.md)
- [MockFacetWithPureFunctions](MockFacet.sol/contract.MockFacetWithPureFunctions.md)
